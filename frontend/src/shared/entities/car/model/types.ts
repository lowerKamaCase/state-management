...
export interface CarsQueryParams extends CarsFilters, CarsSort, CarsPage {}
...
export const DEFAULT_FILTERS: CarsFilters = {};
export const DEFAULT_SORT: CarsSort = { sortBy: 'createdAt', order: 'desc' };
export const DEFAULT_PAGE: CarsPage = { page: 1, pageSize: 20 };
